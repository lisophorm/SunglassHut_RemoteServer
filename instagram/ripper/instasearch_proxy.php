...
$proxyauth="lisophorm:k0st0golov";
$proxy="us.proxymesh.com:31280";

$tags = array("sunglesses", "sunglasses", "sunglasses", "sunglasses");
$ids =array("91dcb12e16704f539e730a82afe0f6b6","c7571e246e584f0fb042ecd3c6e2b3bf","e13e851525c1418d8e2ae4e3df5420af","f61a2746f7df4402b567dc159a3daa9b");
...
function get_api($apcall) {

$response = get_curl($apcall);
...
if(isset($encoded->data)){
	...
	if($conto==0) {
		echo "no images first attempt<br/>";
		$enc2=get_api($encoded->pagination->next_url);
		$conto2=pull_data($enc2);
		echo "second attempt".$conto2."<br/>";
		if($conto2==0) {
				$enc3=get_api($enc2->pagination->next_url);
				$conto3=pull_data($enc3);
				echo "third attempt".$conto2."<br/>";
		}
