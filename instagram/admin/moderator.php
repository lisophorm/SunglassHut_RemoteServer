...
$query_tweets = "SELECT id, approved, mysqldate, from_user, flagged,text, profile_image_url FROM tweets ORDER BY mysqldate DESC ";
...
<META HTTP-EQUIV="Refresh" CONTENT="120; URL=moderator.php"> 
...
<table>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_tweets['from_user']; ?></td>
      <td><?php echo $row_tweets['text']; ?></td>
      <td><img name="" src="<?php echo $row_tweets['profile_image_url']; ?>" alt="" /></td>
    </tr>
