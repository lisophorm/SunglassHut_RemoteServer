...
$query_instagrams = "SELECT id, approved, tag, instagram_id, thumb, `date`, userpic, userfullname, created, caption, transferred FROM instagram WHERE transferred = 0 ORDER BY created DESC";
...
<table border="1" style="margin-left:auto;margin-right:auto;">
  <tr  style="text-align: center; color: #FFF;">
    <td colspan="11" align="left" ><a href="prefs.php">change preferences </a> - <a href="alreadypublished.php">block published tweets</a></td>
  </tr>
