...
<body>
<?php require_once('/var/www/vhosts/wassermanexperience.com/sunglasshut/Connections/localhost.php'); ?>
<?php
//
...
function parseXML($xmlfile) {
	$fileXML="/var/www/vhosts/wassermanexperience.com/sunglasshut/batchincoming/".$xmlfile;
